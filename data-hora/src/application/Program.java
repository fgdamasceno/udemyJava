...
//
//		
		// INSTANCIAÇAO DE DATA-HORA LOCAL (LocalDate/LocalDateTime) E GLOBAL (Instant)
...
//		System.out.println("Day of the month: " + d30.getMonthValue());
//		System.out.println("Day of the month: " + d30.getMonth());
//		System.out.println("Day of the month: " + d30.getYear());
//		System.out.println("Day of the month: " + d30.getDayOfYear());
//		
//		System.out.println("Hour: " + d31.getHour());
//		System.out.println("Hour: " + d31.getMinute());
...
//		diaAtual = LocalDateTime.now().getHour();
//		System.out.println("São " + diaAtual + " horas");
//		diaAtual = LocalDateTime.now().getMinute();
//		System.out.println("E " + diaAtual + " minutos.");
		
		
		
		// Calculo com data e hora;
		LocalDate d40 = LocalDate.parse("2024-06-25");
		LocalDateTime d41 = LocalDateTime.parse("2024-06-25T23:05:59");
		Instant d42 = Instant.parse("2024-06-25T23:30:30Z");
		
		LocalDate pastWeekLocalDate = d40.minusDays(7);
		System.out.println(d40 + " : " + pastWeekLocalDate);
		
		LocalDate nextWeekLocalDate = d40.plusDays(7);
		System.out.println(d40 + " : " + nextWeekLocalDate);
		
		LocalDateTime pastWeekLocalDateTime = d41.minusDays(7);
		System.out.println(d41 + " : " + pastWeekLocalDateTime);
		
		LocalDateTime nextWeekLocalDateTime = d41.plusDays(7);
		System.out.println(d41 + " : " + nextWeekLocalDateTime);
		
		LocalDateTime pastMonthsLocalDateTime = d41.minusMonths(5);
		System.out.println(d41 + " : " + pastMonthsLocalDateTime);
		
		Instant pastWeekInstant = d42.minus(7, ChronoUnit.DAYS);
		System.out.println(d42 + " : " + pastWeekInstant);
		
		Instant nextWeekInstant = d42.plus(7, ChronoUnit.DAYS);
		System.out.println(d42 + " : " + nextWeekInstant);


		// Duração
		Duration t1 = Duration.between(pastWeekInstant, d42);
		System.out.println(t1.toDays());
		
//		Duration t2 = Duration.between(pastWeekLocalDate.atTime(0, 0), d40.atTime(0, 0)); // onde 0s correspondem a h:m; ou abaixo
		Duration t2 = Duration.between(pastWeekLocalDate.atStartOfDay(), d40.atStartOfDay());
